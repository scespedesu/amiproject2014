...
% \usepackage{etoolbox}
% \patchcmd{\thebibliography}{\leftmargin\labelwidth}{\itemsep 0pt \leftmargin\labelwidth}{}{}
...
%
\author{\IEEEauthorblockN{Diego F. Ram\'{i}rez\authorrefmark{1} and Sandra C\'{e}spedes\authorrefmark{2}\authorrefmark{1}\\}
\IEEEauthorblockA{\authorrefmark{1}Department of Information and Communications Technology, Icesi University, Cali, Colombia\\}
\IEEEauthorblockA{\authorrefmark{2}Department of Electrical Engineering, Universidad de Chile, Santiago, Chile\\
Email: dframirez@icesi.edu.co, scespedes@ing.uchile.cl}}
...
\begin{center}
\begin{table}[ht!]
\caption{Comparison of Routing Protocols in the AMI scope \cite{Wang2010} \cite{Rührup2009} \cite{Perkins2003} \cite{Toimoor2013} \cite{Johnson2007}  \cite{Dawson2010} }
\label{table:comparison}
%\centering
\includegraphics [width=18cm] {COMPARATIVE_TABLE}
\end{table}
\end{center}
...
%%
%%
%The authors acknowledge the financial support of Icesi University for the development of this work.
